...
public class DriverScript_old {
	...
	public DriverScript_old() throws  NoSuchMethodException, SecurityException
	{
	...
	public static void main(String [] args) throws Exception
	{
		...
		*/
		...
		DriverScript_old DriverScript=new DriverScript_old(); //this class object for calling the constructor, since we are initializing the class in constructor
