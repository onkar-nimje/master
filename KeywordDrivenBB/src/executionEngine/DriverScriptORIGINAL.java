...
public class DriverScriptORIGINAL {
	...
	public DriverScriptORIGINAL() throws  NoSuchMethodException, SecurityException
	{
	...
	private void execute_TestCase() throws Exception
	{
		...
		//This will return total number of test flows mentioed in test flow sheet
		int iTotaltestFlows = ExcelUtils.getRowCount(Constants.Sheet_TestFlows);
		System.out.println("Total numner of flows ::"+iTotaltestFlows);
