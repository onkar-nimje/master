...
public class webdriverTest {
	...
	*/
	...
	public void login1(String username, String password) //it return username and password
	{
	...
	public void login2 (RegistrationData registrationdata2) // it returns objects
	{
    ...
    // here we are using CSV data driven technique
	@Test(dataProvider = "dataCSV", dataProviderClass=RegistrationData.class)
	public void login3 (RegistrationData registrationdata3)
	{
		driver.get("https://www.facebook.com");
		NewRegistration newregistration=new NewRegistration(driver);
		newregistration.login(registrationdata3);
	}
