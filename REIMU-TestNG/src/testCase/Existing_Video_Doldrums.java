...
public class Existing_Video_Doldrums {
	...
	final static String ScreenshotLocation = "D://workspaces//Selenuim//REIMU-TestNG//test-output//OutPut//Screenshot//Video//Existing_Video_Doldrums//";
	...
	public Existing_Video_Doldrums() {
	 ...
	 public void searchVideo(String videoName,String videoUrl) throws Exception {
		 //HomePage.btnViewAllVideos(driver,wait).click();
		 ...
		 videoValidation.testValidationMsg(driver,wait,"Existing_Video_Doldrums","searchVideo",videoName);
		 updateVideoPage.openVideoUpdatePage(driver, videoUrl);
	 ...
	 public void ProdOOSMsg(String videoUrl,String template,String oosPrdName,String expMsg, String btn) throws Exception {
		 ...
		 videoValidation.testValidationMsg(driver,wait,"Existing_Video_Doldrums","ProdOOSMsg",expMsg);
	 ...
	 @Parameters({"sVideoURL","sOOSPrdName","sCategoryURL","sButtonName"})    
	 public void ProdOOSRedirect1(String videoUrl,String oosPrdName,String prdCatURL, String btn) throws Exception {
		 UpdateVideoPage.VideoPreviewSection.imagePrd(driver, wait, ".0.1.0.0.0.0:$0");
		 UpdateVideoPage.VideoPreviewSection.btnPlusSignOnProduct(driver, wait, ".0.1.0.0.0.0:$0.1").click();
		 ...
		 videoValidation.testValidationMsg(driver, wait,"Existing_Video_Doldrums","ProdOOSRedirect1", prdCatURL);	
	 ...
	 @Parameters({"sVideoURL","sOOSPrdName","sCategoryURL","sButtonName"})   
	 public void ProdOOSRedirect2(String videoUrl,String oosPrdName,String prdCatURL,String btn) throws Exception {
		 UpdateVideoPage.VideoPreviewSection.imagePrd(driver, wait, ".0.1.0.0.0.0:$0");
		 UpdateVideoPage.VideoPreviewSection.btnPlusSignOnProduct(driver, wait, ".0.1.0.0.0.0:$0.1").click();
		 ...
		 UpdateVideoPage.VideoPreviewSection.ProductDetailSection.btnAddToCart(driver,wait).click(); 
		 SpecialAction.switchNextWindow(driver);
		 videoValidation.testValidationMsg(driver,wait,"Existing_Video_Doldrums","ProdOOSRedirect2", prdCatURL);
		 SpecialAction.switchToMainWindow(driver);
		 UpdateVideoPage.VideoPreviewSection.switchFrame(driver, wait, "iframeModal");
		 UpdateVideoPage.VideoPreviewSection.ProductDetailSection.btnClose(driver,wait).click();
	 }
	 ...
	 @Parameters({"sVideoURL","sAvailablePrdName","sSkuOOSmsg","sButtonName"})
	 public void SkuOOSMsg(String videoUrl,String availablePrdName,String expMsg,String btn) throws Exception {
		 ...
		 UpdateVideoPage.VideoPreviewSection.ProductDetailSection.skuSize(driver,wait,2);
		 UpdateVideoPage.VideoPreviewSection.ProductDetailSection.btnAddToCart(driver,wait).click(); 
		 videoValidation.testValidationMsg(driver,wait,"Existing_Video_Doldrums","SkuOOSMsg",expMsg);
		 UpdateVideoPage.VideoPreviewSection.ProductDetailSection.btnClose(driver,wait).click();
	 }
	 
	 //USER REDIRECTING TO PDP PAGE OF PRODUCT FOR AVAILABLE SKU
	 @Test(priority=6,enabled=true)
	 @Parameters({"sVideoURL","sAvailablePrdName","sPDPURL","sButtonName"})
	 public void SkuAvailableRedirect(String videoUrl,String availablePrdName,String pdpURL,String btn) throws Exception {
		 UpdateVideoPage.VideoPreviewSection.imagePrd(driver, wait, ".0.1.0.0.0.0:$1");
		 UpdateVideoPage.VideoPreviewSection.btnPlusSignOnProduct(driver, wait, ".0.1.0.0.0.0:$1.1").click();
		 ...
		 SpecialAction.switchNextWindow(driver);
		 videoValidation.testValidationMsg(driver,wait, "Existing_Video_Doldrums","SkuAvailableRedirect", pdpURL);
		 SpecialAction.switchToMainWindow(driver);	
