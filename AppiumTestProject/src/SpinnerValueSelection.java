...
public class SpinnerValueSelection {
	...
	public static void main(String[] args) throws MalformedURLException, InterruptedException {
		...
		WebElement spinner2 = driver.findElement(By.id("io.appium.android.apis:id/spinner2"));
		spinner2.findElement(By.id("android:id/text1")).click();
