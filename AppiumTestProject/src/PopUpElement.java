...
public class PopUpElement {
	...
	public static void main(String[] args) throws MalformedURLException, InterruptedException {
		...
		Thread.sleep(5000);
          ...
          WebElement listText = driver.findElement(By.className("android.widget.ScrollView")).findElement(By.id("io.appium.android.apis:id/spinner1")).findElement(By.id("android:id/text1"));
          listText.click();
          //Select item "Mars" from drop down list.
		  WebElement popupElement = driver.findElement(By.id("android:id/select_dialog_listview"));
		  popupElement.findElement(By.name("Earth")).click();
